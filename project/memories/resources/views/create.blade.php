...
@csrf
            ...
            <input type="text" name="title" class="form-control form-control-sm" placeholder="عنوان خاطر" required>
            <textarea name="text" class="form-control textarea1" rows="10" id="exampleTextarea" placeholder="متن خاطره" required></textarea>

            <button type="submit" class="btn reg-button btn-sm my-3 button-default">ثبت</button>
            <a href="{{route('getList')}}" class="btn reg-button btn-sm my-3 button-default">بازگشت</a>
